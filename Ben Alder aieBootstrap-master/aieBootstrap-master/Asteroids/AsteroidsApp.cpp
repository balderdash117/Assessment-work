...
void AsteroidsApp::draw() {
	...
	if (mBall.mX != -1)
	{
		...
		m_2dRenderer->drawSprite(m_chest, mBall.mX, mBall.mY, 45.f, 45.f, 0.0f);
	}
	...
	m_2dRenderer->drawSprite(m_myImage, mPlayer.mX, mPlayer.mY, 80.0f, 80.0f, m_rotation);
	...
	m_2dRenderer->drawSprite(m_controls, (float) getWindowWidth() - 210, (float) getWindowHeight() - 150, 260, 200, 0.f, 5.f);
